...
err_t courses_lookup_info_response_encode(courses_lookup_params_t* params, struct __message_t* out_msg);
err_t courses_lookup_info_response_decode(struct __message_t* msg, courses_lookup_params_t* params);
