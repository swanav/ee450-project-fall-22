...
typedef void (*udp_message_rx_cb)(udp_server_t* server, udp_endpoint_t* src, udp_dgram_t* dgram);
typedef void (*udp_message_tx_cb)(udp_server_t* server, udp_endpoint_t* dst, udp_dgram_t* dgram);
